"""
Richards benchmark using super() — pyperformance variant.
Same as bm_richards but uses super().__init__() instead of
explicit ParentClass.__init__(self, ...) calls.
"""
...
loop_i = 0
while loop_i < ITERATIONS:
    result = richard.run(1)
    if not result:
        print("ERROR: incorrect result")
        break
    loop_i += 1
elapsed = time.perf_counter() - t0
print("richards_super ms=")
print(elapsed * 1000)
print("ok")
