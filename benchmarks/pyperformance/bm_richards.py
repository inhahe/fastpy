"""
Richards benchmark from pyperformance (the official CPython benchmark suite).
...
Source: pyperformance 1.14.0 (bm_richards/run_benchmark.py)
...
if __name__ == "__main__":
    ...
    print("richards: %.1f ms (%d iterations)" % (elapsed * 1000, ITERATIONS))
